                      ...
                      <div class="mt-3">
                        ...
                        <script>
                          document.getElementById("excel").addEventListener("click",()=>{
                            location.href="excel/customer_excel.php"
                          });
                        </script>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Add Customers</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row g-2">
                                  <div class="col mb-0">
                                    ...
                                    <input type="text" id="gst" class="form-control" placeholder="GST No" style="text-transform:uppercase"  />
                      ...
                      <div class="mt-3">
                        ...
                        <div class="modal fade" id="modalCenter" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Edit Customers</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                                  data-bs-dismiss="modal"
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row g-2">
                                  <div class="col mb-0">
                                    <label for="egst" class="form-label">GST No</label>
                                    <input
                                      type="text"
                                      id="egst"
                                      class="form-control"
...
button.innerHTML = '<i class="bx bx-dots-vertical-rounded"></i>';
...
editLink.innerHTML = '<i class="bx bx-edit-alt me-1"></i> Edit';

let deleteLink = document.createElement("a");
deleteLink.classList.add("dropdown-item");
deleteLink.setAttribute("href", "javascript:void(0);");
deleteLink.innerHTML = '<i class="bx bx-trash me-1"></i> Delete';
...
tableData1.innerHTML = '<i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>'+data.data[i].name+'</strong>';
let tableData2 = document.createElement("td");
tableData2.textContent = data.data[i].gst;
let tableData3 = document.createElement("td");
tableData3.textContent = data.data[i].address;
let tableData4 = document.createElement("td");
tableData4.appendChild(dropdown);
...
async function deleteCustomer(id) {
  function loaddata(){
  newform = new FormData();
    newform.append("obj", "customer_delete");
