        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a  class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="jalaram_logo.jpg" height="150px" width="150px" style="border-radius:40px"><br>
                      <defs>
                        <path
              ...
              <!-- /Logo -->
              <center><h4 class="mb-2">Welcome To Jalaram Travels</h4></center>
              <center><p class="mb-4">Please Log-in to your account to continue</p></center>
              ...
              <form id="login" >
                ...
                <div class="mb-3">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="remember-me" hidden/>
                  </div>
                </div>
                <div class="mb-3">
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="modalToggleLabel">Login Error!</h5>
